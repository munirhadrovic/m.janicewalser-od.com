...
<html>
	<head>
		...
		<title>Welcome to Family Eyecare Jan Walser O.D.</title>
	...
	<body>
		...
		<div data-role="footer" data-theme="<?php echo $theme ?>" data-position="fixed">
			<h1>Powered by <a href="http://mobilegrows.com/">MobileGrows</a> | <a href="http://janicewalser-od.com/" rel="external">Desktop Site</a></h1>
		</div>
		<!-- page 1 ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
		  ...
		  <div data-role="main" class="ui-content" data-theme="<?php echo $theme ?>">
			  	...
			  	<div class="callbacks_container">
				    <ul class="rslides" id="slider4">
				      ...
				      <li>
				        <img src="img/slider-images/Screenshot_10.png" alt="">
				...
				<div class="ui-grid-a" data-theme="<?php echo $theme ?>">
					...
					<div class="ui-block-b buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#home" data-transition="<?php echo $transitionefect ?>">Products</a></div>
				</div>
				<div class="ui-grid-a" data-theme="<?php echo $theme ?>">
                    <div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-clock ui-btn-icon-left buttons-radius" href="#home" data-transition="<?php echo $transitionefect ?>">Office Hours</a></div>
                    <div class="ui-block-b buttons-semir "><a class="ui-btn ui-icon-mail ui-btn-icon-left buttons-radius" href="#contactform" data-transition="<?php echo $transitionefect ?>">Contact Us</a></div>
				</div>
		  </div>
		  <h2>Services We Provide</h2>
            <p>Our eye examination is comprehensive. It includes a refraction, visual analysis, peripheral vision screening, depth perception, color vision and glaucoma testing, and a biomicroscopy of the interior
                and exterior structures of the eye.</p>
